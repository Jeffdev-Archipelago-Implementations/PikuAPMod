...
namespace PikunikuAPMod
{
    public static class ArchipelagoConstants
    {
        ...
        public static readonly Dictionary<string, long> Locations = new Dictionary<string, long>
        {
            ...
            { "Apple in Tree", BaseId + 23 },
            { "Apple from Bird Quest", BaseId + 24 },
            { "Apple from Hidden Rock", BaseId + 25 },
            ...
            { "Apple Temple: Coin next to spring", BaseId + 64 },
            { "Apple Temple: Coin on spike trap", BaseId + 65 },
            { "Apple Temple: Coin on first platform between spikes", BaseId + 66 },
            { "Apple Temple: Coin on second platform between spikes", BaseId + 67 },
            { "Apple Temple: Coin near hidden room", BaseId + 68 },
            { "Apple Temple: Coin after breakable rock 1", BaseId + 69 },
            { "Apple Temple: Coin after breakable rock 2", BaseId + 70 },
            { "Apple Temple: Coin after breakable rock 3", BaseId + 71 },
            { "Apple Temple: Coin requiring 2 buttons puzzle 1", BaseId + 72 },
            { "Apple Temple: Coin requiring 2 buttons puzzle 2", BaseId + 73 },
            { "Apple Temple: Coin requiring 2 buttons puzzle 3", BaseId + 74 },
            { "Apple Temple: Coin requiring 2 buttons puzzle 4", BaseId + 75 },
            { "Apple Temple: Coin requiring 2 buttons puzzle 5", BaseId + 76 },
            { "Apple Temple: Coin requiring 2 buttons puzzle 6", BaseId + 77 },
            { "Apple Temple: Coin between spike ceilings", BaseId + 78 },
            { "Apple Temple: Coin at start of bounce pad chain", BaseId + 79 },
            { "Apple Temple: Coin at end of temple 1", BaseId + 80 },
            { "Apple Temple: Coin at end of temple 2", BaseId + 81 },
            { "Apple Temple: Coin at end of temple 3", BaseId + 82 },
            { "Apple Temple: Coin at end of temple 4", BaseId + 83 },
            { "Valley Road: Coin at start", BaseId + 84 },
            { "Valley Road: Coin near hooks", BaseId + 85 },
            { "Valley Road: Coin on clouds above hooks", BaseId + 86 },
            { "Valley Road: Coin on clouds after boulders", BaseId + 87 },
            { "Valley Road: Coin in mushroom cave", BaseId + 88 },
            { "Valley Road: Coin on lower cave after door 1", BaseId + 89 },
            { "Valley Road: Coin on lower cave after door 2", BaseId + 90 },
            { "Valley Road: Coin on lower cave after door 3", BaseId + 91 },
            { "Valley Road: Coin on upper cloud near flower", BaseId + 92 },
            { "Valley Road: Coin on moving cloud 1", BaseId + 93 },
            { "Valley Road: Coin on moving cloud 2", BaseId + 94 },
            { "Valley Road: Coin on moving cloud 3", BaseId + 95 },
            { "Valley Road: Coin on moving cloud 4", BaseId + 96 },
            { "Valley Road: Coin on moving cloud 5", BaseId + 97 },
            { "Valley Road: Coin on moving cloud 6", BaseId + 98 },
            { "Valley Road: Coin on moving cloud 7", BaseId + 99 },
            { "Valley Road: Coin on moving cloud 8", BaseId + 100 },
            { "Valley Road: Coin on moving cloud 9", BaseId + 101 },
            { "Valley Road: Coin on moving cloud 10", BaseId + 102 },
            { "Valley Road: Coin on moving cloud 11", BaseId + 103 },
            { "Valley Road: Coin on moving cloud 12", BaseId + 104 },
            { "Valley Road: Coin on moving cloud 13", BaseId + 105 },
            { "Valley Road: Coin on moving cloud 14", BaseId + 106 },
            { "Valley Road: Coin at end of moving clouds", BaseId + 107 },
            { "Valley Road: Coin in hook upper hidden room 1", BaseId + 108 },
            { "Valley Road: Coin in hook upper hidden room 2", BaseId + 109 },
            { "Valley Road: Coin in hook upper hidden room 3", BaseId + 110 },
            { "Valley Road: Coin in hook upper hidden room 4", BaseId + 111 },
            { "Valley Road: Coin on zipline", BaseId + 112 },
            { "Valley Road: Coin on tree branch", BaseId + 113 },
            { "Valley Road: Coin near trees", BaseId + 114 },
            { "Forest: Coin on cut down log", BaseId + 115 },
            { "Forest: Coin on triple cut down logs 1", BaseId + 116 },
            { "Forest: Coin on triple cut down logs 2", BaseId + 117 },
            { "Forest: Coin on ramp", BaseId + 118 },
            { "Forest: Coin on first log gear", BaseId + 119 },
            { "Forest: Coin on top of first log gear log", BaseId + 120 },
            { "Forest: Coin on second log gear", BaseId + 121 },
            { "Forest: Coin on fourth log", BaseId + 122 },
            { "Forest: Coin between logs", BaseId + 123 },
            { "Forest: Coin on fifth log gear", BaseId + 124 },
            { "Forest: Coin under sixth log gear", BaseId + 125 },
            { "Forest: Coin near owl on log", BaseId + 126 },
            { "Forest: Coin after logs", BaseId + 127 },
            { "Forest: Coin on town tree branch left", BaseId + 128 },
            { "Forest: Coin on town tree branch right", BaseId + 129 },
            { "Forest: Coin above community house", BaseId + 130 },
            { "Forest: Coin to the right of toastopia house", BaseId + 131 },
            { "Forest: Coin after rope bridge right of houses", BaseId + 132 },
            { "Forest: Coin atop last tree branch 1", BaseId + 133 },
            { "Forest: Coin atop last tree branch 2", BaseId + 134 },
            { "Forest: Coin on moving cloud 1", BaseId + 135 },
            { "Forest: Coin on moving cloud 2", BaseId + 136 },
            { "Forest: Coin on moving cloud 3", BaseId + 137 },
            { "Forest: Coin on moving cloud 4", BaseId + 138 },
            { "Forest: Coin on moving cloud 5", BaseId + 139 },
            { "Forest: Coin on moving cloud 6", BaseId + 140 },
            { "Forest: Coin on moving cloud 7", BaseId + 141 },
            { "Forest: Coin on moving cloud 8", BaseId + 142 },
            { "Forest: Coin on moving cloud 9", BaseId + 143 },
            { "Forest: Coin on moving cloud 10", BaseId + 144 },
            { "Forest: Coin on moving cloud 11", BaseId + 145 },
            { "Forest: Coin on moving cloud 12", BaseId + 146 },
            { "Forest: Coin on moving cloud 13", BaseId + 147 },
            { "Forest: Coin on moving cloud 14", BaseId + 148 },
            { "Forest: Coin on moving cloud 15", BaseId + 149 },
            { "Frog Temple: Coin left of entrance 1", BaseId + 150 },
            { "Frog Temple: Coin left of entrance 2", BaseId + 151 },
            { "Frog Temple: Coin left of entrance 3", BaseId + 152 },
            { "Frog Temple: Coin on spike trap", BaseId + 153 },
            { "Frog Temple: Coin before hook", BaseId + 154 },
            { "Frog Temple: Coin after 2nd checkpoint", BaseId + 155 },
            { "Frog Temple: Coin above arrow pit", BaseId + 156 },
            { "Frog Temple: Coin at symbol puzzle hint", BaseId + 157 },
            { "Frog Temple: Coin at nut bridge puzzle 1", BaseId + 158 },
            { "Frog Temple: Coin at nut bridge puzzle 2", BaseId + 159 },
            { "Frog Temple: Coin at nut bridge puzzle 3", BaseId + 160 },
            { "Valley Road (Revisited): Coin in hidden hook room 1", BaseId + 161 },
            { "Valley Road (Revisited): Coin in hidden hook room 2", BaseId + 162 },
            { "Valley Road (Revisited): Coin in hidden hook room 3", BaseId + 163 },
            { "Valley Road (Revisited): Coin in hidden hook room 4", BaseId + 164 },
            { "Valley (Revisited): Coin above lower cornfield 1", BaseId + 165 },
            { "Valley (Revisited): Coin above lower cornfield 2", BaseId + 166 },
            { "Valley (Revisited): Coin above lower cornfield 3", BaseId + 167 },
            { "Valley (Revisited): Coin above lower cornfield 4", BaseId + 168 },
            { "Valley (Revisited): Coin in air between cornfields 1", BaseId + 169 },
            { "Valley (Revisited): Coin in air between cornfields 2", BaseId + 170 },
            { "Valley (Revisited): Coin above upper cornfield 1", BaseId + 171 },
            { "Valley (Revisited): Coin above upper cornfield 2", BaseId + 172 },
            { "Valley (Revisited): Coin above upper cornfield 3", BaseId + 173 },
            { "Valley (Revisited): Coin above upper cornfield 4", BaseId + 174 },
            { "Cave: Coin in spring tunnel 1", BaseId + 175 },
            { "Cave: Coin in spring tunnel 2", BaseId + 176 },
            { "Cave: Coin in spring tunnel 3", BaseId + 177 },
            { "Cave: Coin in spring tunnel 4", BaseId + 178 },
            { "Cave: Coin after first pipe tunnel 1", BaseId + 179 },
            { "Cave: Coin after first pipe tunnel 2", BaseId + 180 },
            { "Cave: Coin before detonator tunnel 1", BaseId + 181 },
            { "Cave: Coin before detonator tunnel 2", BaseId + 182 },
            { "Cave: Coin before detonator tunnel 3", BaseId + 183 },
            { "Cave: Coin before detonator tunnel 4", BaseId + 184 },
            { "Cave: Coin near moving platforms", BaseId + 185 },
            { "Cave: Coin after first resistance puzzle 1", BaseId + 186 },
            { "Cave: Coin after first resistance puzzle 2", BaseId + 187 },
            { "Cave: Coin hidden near plant", BaseId + 188 },
            { "Cave: Coin after second resistance puzzle", BaseId + 189 },
            { "Cave: Coin above worm room 1", BaseId + 190 },
            { "Cave: Coin above worm room 2", BaseId + 191 },
            { "Cave: Coin under worm room", BaseId + 192 },
            { "Cave: Coin above ernie worm", BaseId + 193 },
            { "Cave: Coin above gray spinning cross 1", BaseId + 194 },
            { "Cave: Coin above gray spinning cross 2", BaseId + 195 },
            // Appended out of area order to keep all existing IDs stable (the Forest dump
            // turned up a third "triple cut down logs" coin after the table was numbered).
            { "Forest: Coin on triple cut down logs 3", BaseId + 196 }
        };
        ...
        public static readonly Dictionary<string, long> Items = new Dictionary<string, long>
        {
            ...
            { "Sam the Slime", BaseId + 14 },
            { "The Resistance", BaseId + 15 },
            { "A Giant Robot", BaseId + 16 },
            { "The Demonic Toast", BaseId + 17 },
            { "PikDug", BaseId + 18 },
            { "Piku at the Beach", BaseId + 19 },
            { "The Worms", BaseId + 20 },
            { "Ernie the Worm", BaseId + 21 },
            { "Sunshine Inc. Robot", BaseId + 22 },
            { "Mr. Sunshine", BaseId + 23 },
            { "Baskick Champion", BaseId + 24 },
            { "Walking Piku", BaseId + 25 },
            { "The Hidden Rock", BaseId + 26 },
